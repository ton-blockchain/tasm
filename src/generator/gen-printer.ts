    ...
    switch (arg.$) {
        ...
        case "inlineCodeSlice":
            return [
                t.expressionStatement(
                    t.callExpression(
                        t.memberExpression(PRINTER_QUALIFIER, t.identifier("printCode")),
                        [
                            t.identifier("p"),
        ...
        case "slice":
            return [
                t.expressionStatement(
                    t.callExpression(
                        t.memberExpression(PRINTER_QUALIFIER, t.identifier("printSlice")),
                        [
                            t.identifier("p"),
                            t.memberExpression(t.identifier("instr"), t.identifier(name)),
                        ],
...
const generateDictpush = (): t.Statement[] => {
    return [
        ...
        t.expressionStatement(
            t.callExpression(
                t.memberExpression(PRINTER_QUALIFIER, t.identifier("printDictionary")),
                [
                    t.identifier("p"),
