...
export const LSHIFT_VAR: $.Type<c.LSHIFT_VAR> = {
    load: s => {
        s.skip(8)
        return c.LSHIFT_VAR()
    },
...
export const QLSHIFT_VAR: $.Type<c.QLSHIFT_VAR> = {
    load: s => {
        s.skip(16)
...
export const BCHKBITS_VAR: $.Type<c.BCHKBITS_VAR> = {
    load: s => {
        s.skip(16)
...
export const BCHKBITSQ_VAR: $.Type<c.BCHKBITSQ_VAR> = {
    load: s => {
        s.skip(16)
...
export const RSHIFT_VAR: $.Type<c.RSHIFT_VAR> = {
    load: s => {
        s.skip(8)
        return c.RSHIFT_VAR()
    },
...
export const QRSHIFT_VAR: $.Type<c.QRSHIFT_VAR> = {
    load: s => {
        s.skip(16)
...
export const PUSHINT_4: $.Type<c.PUSHINT_4> = {
    load: s => {
        s.skip(4)
...
export const XCHG_0I: $.Type<c.XCHG_0I> = {
    load: s => {
        s.skip(4)
...
export const XCHG_IJ: $.Type<c.XCHG_IJ> = {
    load: s => {
        s.skip(8)
...
export const XCHG_1I: $.Type<c.XCHG_1I> = {
    load: s => {
        s.skip(4)
...
export const PUSHSLICE_LONG: $.Type<c.PUSHSLICE_LONG> = {
    load: s => {
        s.skip(8)
