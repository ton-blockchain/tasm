  ...
  it(
    ...
    test(
      [
        ...
        DICTPUSHCONST(
          19,
          dictMap(new Map([[0, [IFBITJMPREF(2, code([PUSHINT_4(1), PUSHINT_4(1), ADD()]))]]])),
        ),
        DICTIGETJMPZ(),
        THROWARG(11),
      ],
  ...
  it(
    ...
    test(
      [
        ...
        DICTPUSHCONST(
          19,
          dictMap(new Map([[0, [IFNBITJMPREF(2, code([PUSHINT_4(1), PUSHINT_4(2), ADD()]))]]])),
        ),
        DICTIGETJMPZ(),
        THROWARG(11),
      ],
...
`,
  ...
  it(
    ...
    test(
      [
        SETCP(0),
        DICTPUSHCONST(19, dictMap(new Map([[0, [...call(ADD(), PUSHINT_4(1), PUSHINT_4(2))]]]))),
        DICTIGETJMPZ(),
        THROWARG(11),
      ],
      `SETCP 0
    ...
    test(
      [
        ...
        DICTPUSHCONST(
          19,
          dictMap(
            new Map([[0, [...execute(someFunction, PUSHINT_4(1), PUSHINT_4(2), PUSHINT_4(3))]]]),
          ),
        ),
        DICTIGETJMPZ(),
        THROWARG(11),
