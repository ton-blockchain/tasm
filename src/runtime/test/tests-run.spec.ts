...
describe("instructions-execute", () => {
            ...
            new Map([
              [
                ...
                [
                  ...
                  i.PUSH(0),
                  i.GTINT(31),
                  i.PUSHCONT_SHORT(u.code([i.POP(1), i.XCHG_0I(2), i.LDU(32), i.XCHG_0I(3)])),
                  i.IF(),
                  i.PUSH(1),
  ...
  it(
    ...
    test(
      0,
      [SETCP(0), DROP(), NEWC(), STREFCONST(code([PUSHINT_4(5), PUSHINT_4(6), ADD()])), ENDC()],
      emptyData,
      (res: TupleReader) => {
        ...
        expect(print(decompiled)).toEqual(`PUSHINT_4 5\nPUSHINT_4 6\nADD\n`)
      },
    ),
  )
  ...
  it(
    ...
    test(
      ...
      (res: TupleReader) => {
        ...
        expect(print(decompiled2)).toEqual(`PUSHINT_4 6\nPUSHINT_4 7\nSUB\n`)
      },
    ),
  )
})
