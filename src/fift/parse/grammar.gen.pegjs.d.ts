...
export type StartRuleNames = "SourceFile"
export interface ParseOptions<T extends StartRuleNames = "SourceFile"> {
    /**
...
declare function ParseFunction<Options extends ParseOptions<"SourceFile">>(
    input: string,
    options?: Options,
): any
