...
describe("Grammar Rules Compliance", () => {
  describe("vmLine rules", () => {
    test("VmLoc", () => {
      ...
      if (result.$ === "VmLoc") {
        ...
        expect(result.hash).toBe("6DB0B8EFEF2B59D53B896E2A6EBCBBEF72BE9A1F8CD2DA1D0E8EA8F57C4F8AE0")
  ...
  describe("Stack parsing rules", () => {
    ...
    test("VmParsedStack with complex types", () => {
      ...
      if (fifthValue?.value.$ === "CellSlice" && fifthValue.value.body.$ === "CellSliceShortBody") {
