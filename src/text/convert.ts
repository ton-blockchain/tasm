...
export const LSHIFT_VAR: $.Convert = (ctx, instr, loc) => {
    u.assertZeroArgs(instr, loc)
...
export const QLSHIFT_VAR: $.Convert = (ctx, instr, loc) => {
    u.assertZeroArgs(instr, loc)
...
export const BCHKBITS_VAR: $.Convert = (ctx, instr, loc) => {
    u.assertZeroArgs(instr, loc)
...
export const BCHKBITSQ_VAR: $.Convert = (ctx, instr, loc) => {
    u.assertZeroArgs(instr, loc)
...
export const RSHIFT_VAR: $.Convert = (ctx, instr, loc) => {
    u.assertZeroArgs(instr, loc)
...
export const QRSHIFT_VAR: $.Convert = (ctx, instr, loc) => {
    u.assertZeroArgs(instr, loc)
...
export const PUSHINT_4: $.Convert = (ctx, instr, loc) => {
    u.assertSingleArgs(instr, loc)
    const args = $.singleIntegerArg(instr)
...
export const XCHG_IJ: $.Convert = (ctx, instr, loc) => {
    const argsLen = instr.args
    if (argsLen.length !== 2) {
        throw new $.ParseError(loc, "Expected 2 arguments")
    }
...
export const XCHG_1I: $.Convert = (ctx, instr, loc) => {
    const argsLen = instr.args
    if (argsLen.length !== 2) {
        throw new $.ParseError(loc, "Expected 2 arguments")
    }
...
export const PUSHSLICE_REFS: $.Convert = (ctx, instr, loc) => {
    u.assertSingleArgs(instr, loc)
    const args = $.sliceArg(instr)
    return c.PUSHSLICE_REFS(args, loc)
}
export const PUSHSLICE_LONG: $.Convert = (ctx, instr, loc) => {
    u.assertSingleArgs(instr, loc)
    const args = $.sliceArg(instr)
...
export const convertInstruction = (ctx: $.Ctx, instr: $ast.Instruction, loc: c.util.Loc) => {
    ...
    switch (name) {
        ...
        case "LSHIFT_VAR":
            return LSHIFT_VAR(ctx, instr, loc)
        case "LSHIFT":
            return LSHIFT(ctx, instr, loc)
        case "QLSHIFT_VAR":
            return QLSHIFT_VAR(ctx, instr, loc)
        case "QLSHIFT":
            return QLSHIFT(ctx, instr, loc)
        case "BCHKBITS_VAR":
            return BCHKBITS_VAR(ctx, instr, loc)
        case "BCHKBITS":
            return BCHKBITS(ctx, instr, loc)
        case "BCHKBITSQ_VAR":
            return BCHKBITSQ_VAR(ctx, instr, loc)
        case "BCHKBITSQ":
            return BCHKBITSQ(ctx, instr, loc)
        case "RSHIFT_VAR":
            return RSHIFT_VAR(ctx, instr, loc)
        case "RSHIFT":
            return RSHIFT(ctx, instr, loc)
        case "RSHIFT_ALT":
            return RSHIFT_ALT(ctx, instr, loc)
        case "QRSHIFT_VAR":
            return QRSHIFT_VAR(ctx, instr, loc)
        case "QRSHIFT":
        ...
        case "PUSHINT_4":
            return PUSHINT_4(ctx, instr, loc)
        case "PUSHINT_8":
        ...
        case "XCHG_IJ":
            return XCHG_IJ(ctx, instr, loc)
        case "XCHG_1I":
            return XCHG_1I(ctx, instr, loc)
        case "DUMPSTK":
        ...
        case "PUSHSLICE_REFS":
            return PUSHSLICE_REFS(ctx, instr, loc)
        case "PUSHSLICE_LONG":
            return PUSHSLICE_LONG(ctx, instr, loc)
        case "PUSHCONT":
